...
#define DO_DESTRUCTIVE_TEXT_COLOR   DO_RGB(255, 255, 255)
#define DO_DIMMED_COLOR             DO_RGBA(0, 0, 0, 0.9)
...
#define DO_TEXT_FONT        [UIFont fontWithName:@"Bariol-Bold" size:20]
#define DO_BOLD_FONT        [UIFont fontWithName:@"Bariol-Bold" size:20]

#define DO_LABEL_INSET      UIEdgeInsetsMake(10, 10, 10, 10)
#define DO_TITLE_INSET      UIEdgeInsetsMake(5, 10, 5, 10)
#define DO_VIEW_WIDTH       350
...
@property (nonatomic, strong) NSDate *dateForPicker;
// for Map view

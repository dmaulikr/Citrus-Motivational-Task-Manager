...
- (void)setupCell {
    ...
    self.circleButton.backgroundColor = self.menuItem.isSelected == YES ? [UIColor whiteColor] : [UIColor clearColor];
    self.iconView.tintColor = self.menuItem.isSelected == YES ? [UIColor blackColor] : [UIColor whiteColor];
}
...
- (void)buttonTouchDown:(UIButton *)button {
    if (self.blurEffectStyle == CNPBlurEffectStyleDark) {
        if(self.menuItem.retainsSelection == YES)
        {
            button.backgroundColor = button.backgroundColor == [UIColor whiteColor] ? [UIColor clearColor] :[UIColor whiteColor];
            self.iconView.tintColor = button.backgroundColor == [UIColor whiteColor] ? [UIColor blackColor] :[UIColor whiteColor];
        }
        else
        {
...
- (void)buttonTouchUpInside:(UIButton *)button {
    ...
    self.menuItem.isSelected = self.menuItem.isSelected == YES ? NO : YES;
    
    if (self.blurEffectStyle == CNPBlurEffectStyleDark) {
        if(self.menuItem.retainsSelection == NO)
        {
            button.backgroundColor = [UIColor clearColor];
            self.iconView.tintColor = [UIColor whiteColor];
        }
        else if (self.menuItem.retainsSelection == YES)
        {
        }
        else{
            button.backgroundColor = [UIColor clearColor];self.iconView.tintColor = [UIColor whiteColor];
            self.iconView.tintColor = [UIColor whiteColor];
        }
    }
    else {
